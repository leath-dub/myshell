...
bin = myshell
src = src/main.c src/parser.c src/token.c src/redirect.c
obj = main.o parser.o token.o redirect.o
headers = src/parser.h src/redirect.h src/token.h src/command.h
